// Wrecking Ball Project by Shweta Khanna ,Megha Tyagi,	Sejal Kale	, Ansila Riyas Rahman	
...
function setup() {
  ...
  box16 = new Box(700, 100, 100, 100);
  box17 = new Box(700, 100, 100, 100);
  box18 = new Box(700, 100, 100, 100);
  box19 = new Box(700, 100, 100, 100);
  box20 = new Box(700, 100, 100, 100);
...
function draw() {
  ...
  fill("green");
  textSize(30);
  text("Wrecking Ball Project", 300,100 )
